package android.app.ks.thinkit.duovoc.communicate;

import android.app.ks.thinkit.duovoc.communicate.property.Api;
import android.app.ks.thinkit.duovoc.communicate.property.OverviewTranslationJsonProperties;
import android.app.ks.thinkit.duovoc.communicate.property.OverviewTranslationQuery;
import android.app.ks.thinkit.duovoc.framework.IHttpAsync;
import android.app.ks.thinkit.duovoc.framework.StringChecker;
import android.app.ks.thinkit.duovoc.framework.communicate.Request;
import android.app.ks.thinkit.duovoc.framework.communicate.holder.HttpAsyncResults;
import android.app.ks.thinkit.duovoc.framework.communicate.property.RequestMethod;
